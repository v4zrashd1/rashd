// Fast proxy variant #2: caches small repeat downloads at the edge.
export default async function handler(req) {
  ...
  try {
    ...
    const upstream = await fetch(target, {
      ...
      redirect: 'follow',
      // cache full responses at the edge when no range is requested (repeat downloads get instant)
